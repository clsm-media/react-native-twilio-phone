...
import { EventType, TwilioPhone, twilioPhoneEmitter } from 'react-native-twilio-phone'; // import VoipPushNotification from 'react-native-voip-push-notification';
...
class RNTwilioPhone {
  ...
  static async startCall(options) {
    ...
    const uuid = ramdomUuid().toLowerCase(); // RNTwilioPhone.activeCall = { uuid: uuid, sid: null };
